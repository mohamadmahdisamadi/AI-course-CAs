...
def main():
    ...
    snake_1 = Snake(color=(255, 0, 255), pos=(15, 15), file_name=SNAKE_1_Q_TABLE)
    snake_2 = Snake(color=(0, 255, 255), pos=(5, 5),  file_name=SNAKE_2_Q_TABLE)
    snake_1.addCube()
    snake_2.addCube()
    ...
    while True:
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.QUIT:
                ...
                snake_1.save_results("./res11.csv")
                snake_2.save_results("./res22.csv")
                pygame.quit()
                exit()
